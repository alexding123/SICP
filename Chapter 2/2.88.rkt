...
(define (install-polynomial-package)
  ...
  (define (mul-poly p1 p2)
    (if (same-variable? (variable p1) (variable p2))
        ...
        (display "Polys are no in the samve var -- MUL-POLY" (list p1 p2))))
...
(define poly1 (make-polynomial 'x '((1 1))))
(define poly2 (make-polynomial 'x '((2 2) (0 1))))
(sub poly1 poly2)